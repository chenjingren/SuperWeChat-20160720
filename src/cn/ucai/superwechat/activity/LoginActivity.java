...
import cn.ucai.superwechat.task.DownloadContactList;
...
public class LoginActivity extends BaseActivity {
					...
					public void onSuccess(String s) {
						...
						if (result!=null && result.isRetMsg()){
							...
							Toast.makeText(LoginActivity.this,
									R.string.login_failure_failed+ Utils.getResourceString(LoginActivity.this,result.getRetCode()),
									Toast.LENGTH_SHORT).show();
						}
					}
	...
	public void loginEMServerSuccess(UserAvatar user){
		...
		new DownloadContactList(LoginActivity.this,currentUsername).execute();
